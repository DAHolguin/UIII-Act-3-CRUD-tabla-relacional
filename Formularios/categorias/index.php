                ...
                <tbody>
                    ...
                    while ($resultado = $sql->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $resultado['id_empl']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['id_prod']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['id_cli']; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="<?php echo base_url; ?>Formularios/categorias/actualizar.php?id_ventas=<?php echo $resultado['id_ventas']; ?>"
                                    class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDC/eliminarDatos.php?id_ventas=<?php echo $resultado['id_ventas']; ?>"
