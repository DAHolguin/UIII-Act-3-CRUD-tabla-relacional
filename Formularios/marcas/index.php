                ...
                <tbody>
                    ...
                    while ($resultado = $sql->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $resultado['apellidoP']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['apellidoM']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['curp']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['edad']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['metodo_de_pago']; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="<?php echo base_url; ?>Formularios/marcas/actualizar.php?id_cliente=<?php echo $resultado['id_cliente']; ?>"
                                    class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDM/eliminarDatos.php?id_cliente=<?php echo $resultado['id_cliente']; ?>"
